...
public class ModBlocks
{
    ...
    public static final Block LOG = new BlockCustomLog("log");
    public static final Block PLANKS = new BlockCustomPlanks("planks");
    public static final Block SAPLING = new BlockCustomSapling("sapling");
    public static final Block LEAVES = new BlockCustomLeaves("leaves");
}
